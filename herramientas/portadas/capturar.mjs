...
const objetivos = [
  ...
  { slug: 'bazargirl', tel: 'https://bazargirl.pages.dev/', lap: 'https://bazargirl.pages.dev/', bajar: true }, // catálogo real: se baja hasta los productos
  ...
  { slug: 'aglaia', tel: 'https://aglaianails.pages.dev/', lap: 'https://aglaianails.pages.dev/' },
  { slug: 'rawssport', tel: 'https://rawssport.pages.dev/', lap: 'https://rawssport.pages.dev/' },
...
async function toma(url, archivo, movil, bajar) {
...
for (const o of objetivos) {
  if (o.tel) await toma(o.tel, `cap/${o.slug}-tel.png`, true, o.bajar);
  if (o.lap) await toma(o.lap, `cap/${o.slug}-lap.png`, false, o.bajar);
}
await browser.close();
